...
and Declaration =
    ...
    | Data of name:string * typeVariables:(string * Trait list) list * constructors:(string * Type list) list
...
and ExDeclaration =
    ...
    | DeclData of name:string * typeVariables:(string * Trait list) list * constructors:(string * ExType list) list

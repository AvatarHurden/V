...
\infrule[T-Get]
    ...
    {\Gamma \vdash get : \#(X_1 \rightarrow X_2) \rightarrow X_2 \rightarrow X_1  \; | \; \{\}}

\infrule[T-Set]
    {X_1 \; is\; new \andalso X_2 \; is \; new}
    {\Gamma \vdash get : \#(X_1 \rightarrow X_2) \rightarrow X_1 \rightarrow X_2 \rightarrow X_2  \; | \; \{\}}

\infrule[T-Stack]
    {X_1 \; is\; new \andalso X_2 \; is \; new \andalso X_3 \; is \; new\\
    T_1 = \#(X_1 \rightarrow X_2) \andalso T_2 = \#(X_3 \rightarrow X_1)}
    {\Gamma \vdash stack : T_1 \rightarrow T_2 \rightarrow \#(X_3 \rightarrow X_2)  \; | \; \{\}}

\infrule[T-Distort]
    {X_1 \; is\; new \andalso X_2 \; is \; new \andalso X_3 \; is \; new\\
    T_1 = \#(X_1 \rightarrow X_2) \andalso T_2 = X_1 \rightarrow X_3 \andalso T_3 = X_3 \rightarrow X_1}

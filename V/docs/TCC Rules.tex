...
\infrule[BS-AppAccess]
    {\mbox{env} \vdash e_1 \Downarrow \#l \andalso \mbox{env} \vdash e_2 \Downarrow v}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow [\#l \; v]}

\infrule[BS-AppAccess2]
    {\mbox{env} \vdash e_1 \Downarrow [\#l \; v] \andalso \mbox{env} \vdash e_2 \Downarrow \{l_1: v_1, \; \dots \; l_n: v_n\}\\
    l = l_k \andalso 1 \leq \left\|k\right\| \leq \left\|n\right\| \andalso r = \{l_1: v_1, \; \dots \; l_k: v, \; \ldots \; l_n: v_n\}}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow (v_k, r)}
...
\infrule[BS-AppGet2]
    {\mbox{env} \vdash e_1 \Downarrow [get \; \#l] \andalso \mbox{env} \vdash e_2 \Downarrow \{l_1: v_1, \; \dots \; l_n: v_n\}\\
    l = l_k \andalso 1 \leq \left\|k\right\| \leq \left\|n\right\|}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow v_k}
...
\infrule[T-Access]
    ...
    {\Gamma \vdash \#l : X_1 \rightarrow X_2 \rightarrow (X_1, X_2) \; | \; \{\}}

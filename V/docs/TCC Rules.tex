...
\infrule[]
    {path = l_k \andalso 1 \leq \left\|k\right\| \leq \left\|n\right\|\\
    r = \{l_1: v_1, \; \dots \; l_k: v, \; \ldots \; l_n: v_n\}}
    {traverse(path, \{l_1: v_1, ... l_n: v_n\}, v) = v_k, r}

\infrule[]
    {path = l_k \andalso 1 \leq \left\|k\right\| \leq \left\|n\right\| \\
    traverse(paths, v_k, v) = v', v_k' \\
    r = \{l_1: v_1, \; \dots \; l_k: v_k', \; \ldots \; l_n: v_n\}}
...
\infax[BS-Get]
    {\mbox{env} \vdash get \Downarrow get}

\infax[BS-Stack]
    {\mbox{env} \vdash stack \Downarrow stack}
...
\infrule[BS-AppAccess]
    {\mbox{env} \vdash e_1 \Downarrow \#paths \andalso \mbox{env} \vdash e_2 \Downarrow v}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow [\#paths \; v]}

\infrule[BS-AppAccess2]
    {\mbox{env} \vdash e_1 \Downarrow [\#paths \; v] \andalso \mbox{env} \vdash e_2 \Downarrow \{l_1: v_1, \; \dots \; l_n: v_n\}\\
    traverse(paths, e_2, v) = v', r'}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow (v', r')}


\infrule[BS-AppStack]
    {\mbox{env} \vdash e_1 \Downarrow stack \andalso \mbox{env} \vdash e_2 \Downarrow v}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow [stack \; v]}

\infrule[BS-AppStack2]
    {\mbox{env} \vdash e_1 \Downarrow [stack \; \#paths_1] \andalso \mbox{env} \vdash e_2 \Downarrow \#paths_2\\
    paths' = paths_1 ++ paths_2}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow \#paths'}

\infrule[BS-AppGet]
    {\mbox{env} \vdash e_1 \Downarrow get \andalso \mbox{env} \vdash e_2 \Downarrow v}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow [get \; v]}

\infrule[BS-AppGetRaise]
    {\mbox{env} \vdash e_1 \Downarrow [get \; \left\langle p, e, env\right\rangle]}
    {\mbox{env} \vdash e_1 \; e_2 \Downarrow raise}

\infrule[BS-AppGet2]
    {\mbox{env} \vdash e_1 \Downarrow [get \; \#path] \andalso \mbox{env} \vdash e_2 \Downarrow \{l_1: v_1, \; \dots \; l_n: v_n\}\\

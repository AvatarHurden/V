...
\begin{bnf*}
  ...
  \bnfprod{parentheses}
    {\begin{bnfsplit}
      \bnfts{(} \bnfsp \bnfpn{term} \bnfsp \bnfts{)}\\
      \bnfts{(} \bnfsp \bnfpn{term}_1 \bnfsp \bnfts{,} \bnfsk \bnfts{,} \bnfpn{term}_n \bnfts{)} \bnfsp \bnfsp \bnfsp \bnfsp \bnfsp (n \geq 2)\\
      \bnfts{(} \bnfsp \bnfpn{operator} \bnfsp \bnfts{)}\\
  \end{bnfsplit}}
\end{bnf*}

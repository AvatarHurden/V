...
This means that functions are regular expressions, and can be passed as arguments, saved as constants, etc.
...
\paragraph{Constructors and Variables}

$V$ has support for a few basic constructors and variables.
...
The basic constructors available for the language are:

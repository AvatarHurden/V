...
\infrule[BS-TupleProjectionRaise]
    {\mbox{env} \vdash e \Downarrow raise}
    {\mbox{env} \vdash \#n \; e \Downarrow raise}

\infrule[BS-RecordProjectionRaise]
    {\mbox{env} \vdash e \Downarrow raise}
...
\infrule[BS-$\vee$Raise]
    {\mbox{env} \vdash e_1 \Downarrow raise}
    {\mbox{env} \vdash e_1  \vee e_2 \Downarrow raise}

\infrule[BS-$\vee$Raise2]
    {\mbox{env} \vdash e_1 \Downarrow false \andalso \mbox{env} \vdash e_2 \Downarrow raise}
    {\mbox{env} \vdash e_1 \vee e_2 \Downarrow raise}

\infrule[BS-$\wedge$Raise]
    {\mbox{env} \vdash e_1 \Downarrow raise}
    {\mbox{env} \vdash e_1  \wedge e_2 \Downarrow raise}

\infrule[BS-$\wedge$Raise2]
    {\mbox{env} \vdash e_1 \Downarrow true \andalso \mbox{env} \vdash e_2 \Downarrow raise}
    {\mbox{env} \vdash e_1 \wedge e_2 \Downarrow raise}
...
\begin{itemize}
  \item \textbf{Non-Strict Semantics} \; \; { \colorbox{YellowGreen}{Operational Semantics}}

...
\begin{tabular}{cl}
    ...
    $\bnfpn{$pat$}_{\bnfpn{$pat'$}}$ &all patterns accepted by $pattern$,
    \\&except those also accepted by $pattern'$\\
...
\begin{bnf*}
  \bnfprod{program}
    {\bnfpn{whitespace} \bnfsp \bnfpn{term} \bnfsp \bnfpn{eof}}
    \\
  \bnfprod{library}
  ...
  \\
  \bnfprod{comment}
    {\bnfts{\textbackslash\textbackslash} \bnfsp \{ \bnfsp \bnfpn{any} \bnfsp \} \bnfsp \bnfpn{newline}}
  \\
  \\

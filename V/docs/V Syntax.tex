...
\infrule[Tr-P]
  {\text{id}_0 = \emptyset\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i}
...
\infax[Tr-P-Ignore]
  {\text{collectPatterns}(\_, \text{id}, \gamma) = \_, \text{id}}

\infrule[Tr-P-Ignore2]
  {\gamma \vdash T' \Rightarrow T}
  {\text{collectPatterns}(\_ : T', \text{id}, \gamma) = \_ : T, \text{id}}

\infrule[Tr-P-Con]
  {\text{id}_0 = \text{id}\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i}
  {\text{collectPatterns}(con \; p_1', \; \dots \; p_n', \text{id}, \gamma) = con \; p_1, \; \dots \; p_n, \text{id}_n}

\infrule[Tr-P-Con2]
{\text{id}_0 = \text{id} \andalso \gamma \vdash T' \Rightarrow T\\
\forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i\\}
{\text{collectPatterns}(con \; p_1', \; \dots \; p_n' : T', \text{id}, \gamma) = con \; p_1, \; \dots \; p_n : T, \text{id}_n}

\infrule[Tr-P-X]
  {x \notin \text{id}}
  {\text{collectPatterns}(x, \text{id}, \gamma) = x, \text{id} \cup \{x\}}

\infrule[Tr-P-X2]
  {x \notin \text{id} \andalso \gamma \vdash T' \Rightarrow T}
  {\text{collectPatterns}(x : T', \text{id}, \gamma) = x : T, \text{id} \cup \{x\}}

\infrule[Tr-P-Record]
  {\text{id}_0 = \text{id}\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i}
  {\text{collectPatterns}(\{l_1: p'_1, \; \dots \; l_n: p'_n\}, \text{id}, \gamma) = \{l_1: p_1, \; \dots \; l_n: p_n\}, \text{id}_n}

\infrule[Tr-P-Record2]
  {\text{id}_0 = \text{id} \andalso \gamma \vdash T' \Rightarrow T\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i\\}
  {\text{collectPatterns}(\{l_1: p'_1, \; \dots \; l_n: p'_n\} : T', \text{id}, \gamma) = \{l_1: p_1, \; \dots \; l_n: p_n\} : T, \text{id}_n}

\infrule[Tr-P-PartRec]
  {\text{id}_0 = \text{id}\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i}
  {\text{collectPatterns}(\{l_1: p'_1, \; \dots \; l_n: p'_n, \dots\}, \text{id}, \gamma) = \{l_1: p_1, \; \dots \; l_n: p_n, \dots\}, \text{id}_n}

\infrule[Tr-P-PartRec2]
  {\text{id}_0 = \text{id} \andalso \gamma \vdash T' \Rightarrow T\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i\\}
  {\text{collectPatterns}(\{l_1: p'_1, \; \dots \; l_n: p'_n, \dots\} : T', \text{id}, \gamma) = \{l_1: p_1, \; \dots \; l_n: p_n, \dots\} : T, \text{id}_n}

\infrule[Tr-P-List]
  {\text{id}_0 = \text{id}\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i\\
  p = \; :: \; p_1 \; (:: \; p_2 \; \dots (:: \; p_n \; nil) \dots )}
  {\text{collectPatterns}([p_1', \; \dots \; p_n'], \text{id}, \gamma) = p, \text{id}_n}

\infrule[Tr-P-List2]
  {\text{id}_0 = \text{id} \andalso \gamma \vdash T' \Rightarrow T\\
  \forall i \in [1, \; n] \; . \; \text{collectPatterns}(p_i', \text{id}_{i-1}, \gamma) = p_i, \text{id}_i\\
  p = \; :: \; p_1 \; (:: \; p_2 \; \dots (:: \; p_n \; nil) \dots )}
  {\text{collectPatterns}([p_1', \; \dots \; p_n'] : T', \text{id}, \gamma) = p : T, \text{id}_n}

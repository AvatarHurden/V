...
\begin{tabular}{cl}
    ...
    ($pattern$) &grouping of patterns\\
    $pattern_1 \; | \; pattern_2$ &choice\\
    $pattern_{<pattern'>}$ &all patterns accepted by $pattern$,
    \\&except those also accepted by $pattern'$\\
    \code{text} &concrete characters (written in terminal font)
\end{tabular}}

...
This last argument of the $traverse$ function can be ommited and, in such a case, no update is done (that is, the updated record is the same as the input record).
...
Initally, the provided update value is applied to the second component ($v_2$) of the distorted accessor.

...
\\
    ...
    &| &\llbracket Builtin \; . \; v_1, \; \dots v_n \rrbracket &(n < \text{arity} \; Builtin)\\
    &| &\llbracket con \; . \; v_1, \; \dots v_n \rrbracket &(n < \text{arity} \; con)\\
    \\
respath &::= &l\\
    &| &respath \; . \; respath\\
...
The values $\llbracket Builtin \; . \; v_1, \; \dots v_n \rrbracket$ and $\llbracket con \; . \; v_1, \; \dots v_n \rrbracket$ are partial applications of builtin functions and constructors, respectively.
...
\infax[BS-Builtin]
    {\mbox{env} \vdash Builtin \Downarrow \llbracket Builtin \; . \; \rrbracket}
...
\infrule[BS-Con2]
    ...
    {\mbox{env} \vdash con \Downarrow \llbracket con \; . \; \rrbracket}
...
An application expression requires either a closure, a builtin function or a constructor for its left-hand operand.
j\smallskip

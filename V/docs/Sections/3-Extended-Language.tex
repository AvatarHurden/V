...
\infrule[Tr-F-RecT2]
  {\gamma \vdash [x_1', \; \dots \; x_n'] \Rightarrow [x_1, \; \dots \; x_n], \gamma'\\
  f' \; is \; new \andalso \gamma' \cup \{f \rightarrow f'\} \vdash e' \Rightarrow e \andalso \gamma' \vdash T' \Rightarrow T\\
  fn = \texttt{rec} \; f : T \; x_1 \Rightarrow \cdots \texttt{fn} \; x_n \Rightarrow e}
...
\infrule[Tr-Decl-Rec2]
  {\gamma \vdash (\texttt{rec} \; f : T' \; p'_1, \; \dots \; p'_n \Rightarrow e') \Rightarrow e\\
  f' \; is \; new}
